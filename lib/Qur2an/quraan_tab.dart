    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child:   const Image(image: AssetImage('assets/images/qur2an_screen_logo.png'),),),
         ...
         Row(
           ...
           children: [
             ...
             Container(color:Theme.of(context).colorScheme.secondary,height:40 ,width: 2,),
               ...
               child: ListView.builder(
                  ...
                  itemBuilder: (_,index){
                      return InkWell(
                        ...
                        onTap: ()
                        {
                                Navigator.pushNamed(context,ChapterDetails.routeName,arguments: ChapterDetailsArgs(suras[index], index));
                        },
                          child: Row(
                              ...
                              children:[
                                Expanded(child: Text(
                                  ...
                                  Container(color:Theme.of(context).colorScheme.secondary,height:50 ,width: 2,),
